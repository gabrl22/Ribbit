...
import com.example.gabriel.ribbit.adapters.InboxAdapter;
...
public class InboxFragment extends ListFragment {
            ...
            public void done(List<ParseObject> messages, ParseException e) {
                ...
                if(e == null){
                    ...
                    if(getListView().getAdapter() == null) {
                        InboxAdapter adapter = new InboxAdapter(getListView().getContext(),
                                mMessages);
                        setListAdapter(adapter);
                    }
                    else{
                        //refill the the list
                        ((InboxAdapter)getListView().getAdapter()).refill(mMessages);
                    }
                }
            }
        });
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        Uri fileUri = Uri.parse(file.getUrl());
         if(messageType.equals(ParseConstants.FILE_TYPE_IMAGE)){
             //view image
